...
<script>
  function validat(){
    ...
    if (document.form1.phone.value == ""){
      ...
      alert("pelease enter your phone number");
...
<div class="container">
  ...
  <form method="POST" action="doctorHandler.php" name="form1" onsubmit=" return validat();" onsubmit="return phone();">
    
    <div class="form-group">
      <label for="middlename">Full name:</label>
      <input type="name" class="form-control" id="name" placeholder="Enter middlename" name="dname">
    </div>
    <div class="form-group">
